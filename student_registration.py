...
def show():
    global file
    file = askopenfilename(initialdir='C:/Users/COMPUTER/Downloads/online_exam/online_exam/profile images', title='Select Image',
                                       filetypes=[("all files", "*.*")])
...
l1 = tk.Label(window, text="Student Registration", font=("Times new roman", 30, "bold underline"), bg="white", fg="black")
l1.place(x=150, y=50)


# that is for label1 registration

l10 = tk.Label(window, text="Roll No.", width=13, font=("Times new roman", 15, "bold underline"), bg="snow")
l10.place(x=130, y=150)

t10 = tk.Entry(window, textvar=rollno, width=20, font=('', 15))
t10.place(x=330, y=150)

l2 = tk.Label(window, text="Full Name :", width=12, font=("Times new roman", 15, "bold underline"), bg="snow")
...
l3 = tk.Label(window, text="Address :", width=12, font=("Times new roman", 15, "bold underline"), bg="snow")
...
l5 = tk.Label(window, text="E-mail :", width=12, font=("Times new roman", 15, "bold underline"), bg="snow")
l5.place(x=130, y=300)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=330, y=300)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=12, font=("Times new roman", 15, "bold underline"), bg="snow")
l6.place(x=130, y=350)
t5 = tk.Entry(window, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=330, y=350)
# phone number
l7 = tk.Label(window, text="Gender :", width=12, font=("Times new roman", 15, "bold underline"), bg="snow")
...
l8 = tk.Label(window, text="Age :", width=12, font=("Times new roman", 15, "bold underline"), bg="snow")
...
btn = tk.Button(window, text="Register", bg="green",font=("",20),fg="black", width=9, height=1, command=insertBLOB)
