...
l1 = tk.Label(window, text="Create a New Account Here!!", font=("Times new roman", 30, "bold"), bg="white", fg="black")
l1.place(x=140, y=50)
...
btn = tk.Button(window, text="login", bg="blue",font=("",20),fg="white", width=9, height=0, command=login)
